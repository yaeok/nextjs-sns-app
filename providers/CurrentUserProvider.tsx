...
import { auth } from '@/infrastracture/service/firebase/config/config';
import {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      if (user) {
        ...
        const userDB = await userRepository.findById({ id: user.uid })
        ...
        response.setCreatedAt(userDB.getCreatedAt())
